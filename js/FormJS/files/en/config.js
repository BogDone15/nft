var CONFIG = {
	...
	"inputs-template": {
		"fullname": "<div class='form_group--name'><input data-validation-type='fullname' autocomplete='name' type='text' name='fullname' placeholder='Full Name' required><div class='validation'><i class='fjs fjs-exclamation'></i></div><div class='error'></div></div>",
		...
		"email": "<div class='form_group--email'><input type='email' data-validation-type='email' autocomplete='email' name='email' placeholder='Email' required><div class='validation'><i class='fjs fjs-exclamation'></i></div> <div class='error'></div></div>",
